...
def evaluate_with_embeddings_lightgbm(config: dict, support_set: dict, validation_set: dict, data_set: dict, dataset: str):
    """
    Evaluates a LightGBM model using precomputed embeddings on a specified dataset.

    Parameters:
        config (dict): Dictionary containing parameters for the LightGBM model and evaluation process.
