...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_path", required=False, type=str, default='embeddings/dino/',
                        help="Path to the output folder.")
    parser.add_argument("--output_path_acc", required=False, type=str, default='accuracies/dino/gbm/',
                        help="Path to the output folder.")
    ...
    for dataset in ['bloodmnist', 'breastmnist', 'dermamnist', 'octmnist', 'organamnist', 'organcmnist',
        ...
        for img_size in [28, 64, 128, 224]:
            ...
            acc_train, acc_val, acc, bal_acc_train, bal_acc_val, bal_acc, auc_train, auc_val, auc, co_train, co_val, co = evaluate_with_embeddings_gbm(
